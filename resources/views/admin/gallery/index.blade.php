    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18">گالری تصویر</h4>
            ...
            <div class="col-lg-12">
                <div class="card" data-select2-id="10">
                    <div class="card-body" data-select2-id="9">
                        ...
                        <form method="post" action="{{route('admin.galleries.update',$edit_item->id)}}" enctype='multipart/form-data' role="form">
                            {{csrf_field()}}
                            {{method_field('PUT')}}
                            <div class="form-group">
                                ...
                                <input name="title[fa]" type="text" class="form-control"
                                       required
                                       value="{{old('title[fa]',unserialize($edit_item->title)['fa'])}}"
                                       placeholder="عنوان">
                            ...
                            <div class="form-group">
                                ...
                                <input name="title[en]" type="text" class="form-control"
                                       required
                                       value="{{old('title[en]',unserialize($edit_item->title)['en'])}}"
                                       placeholder="عنوان">
                ...
                <div class="card-body">
                    ...
                    <table id="b_datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        @foreach($module as $item)
                            <tr>
                                <td>{{$item->id}}</td>
                                <td>{{unserialize($item->title)['fa']}}</td>
                                <td><img src="{{asset($item->thumb)}}" style="width: 60px;height: 60px" alt=""></td>
                                ...
                                <td>
                                    ...
                                    <form class="form-horizontal deleteConfirm" method="POST"
                                          action="{{route('admin.galleries.destroy',$item->id)}}" role="form">

                                        <a href="{{route('admin.galleries.edit',$item->id)}}" class="">
