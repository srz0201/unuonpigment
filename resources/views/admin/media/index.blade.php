    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18">گالری ویدئو</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">داشبرد</a></li>
                        <li class="breadcrumb-item active">ویدئو</li>
                    </ol>
                </div>
            ...
            <div class="col-lg-12">
                <div class="card" data-select2-id="10">
                    <div class="card-body" data-select2-id="9">
                        ...
                        <form method="post" action="{{route('admin.video.update',$edit_item->id)}}" enctype='multipart/form-data' role="form">
                            {{csrf_field()}}
                            {{method_field('PUT')}}
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class=" control-label">ویدئو (اختیاری)</label>
                                    <input name="video" type="file" class="form-control">
                                    <label class=" control-label">{{asset($edit_item->video)}}</label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class=" control-label">کد iframe (اختیاری)</label>
                                    <textarea name="iframe" class="form-control">{{old('iframe',$edit_item->iframe)}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class=" control-label">نمایش در صفحه اصلی</label>
                                <div class="md-checkbox-inline">
                                    <div class="md-checkbox">
                                        <input type="checkbox" id="checkbox2_4"
                                               name="home" value="1"
                                               @if(old('home',$edit_item->home) == 1) checked @endif
                                               class="md-check">
                                        <label for="checkbox2_4"> فعال </label>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card" data-select2-id="10">
                    <div class="card-body" data-select2-id="9">
                        ...
                        <form method="post" action="{{route('admin.video.store')}}" enctype='multipart/form-data'>
                            ...
                            <div class="form-group">
                                <label class=" control-label">انتخاب عکس کاور</label>
                                <div class="bgColor">
                                    <div style="width: 200px;height: 200px"
                                         class="targetOuter">
                                        <div id="target2" class="targetLayer">
                            ...
                            <div class="form-group">
                                ...
                                <div class="md-checkbox-inline">
                                    <div class="md-checkbox">
                                        <input type="checkbox" id="checkbox2_4"
                                               name="home" value="1"
                                               @if(old('home') == 1) checked @endif
                                               class="md-check">
                                        <label for="checkbox2_4"></label>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <table id="b_datatable" class="table table-striped table-bordered dt-responsive " style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        <thead>
                        <tr>
                            <th>شماره</th>
                            <th>عنوان</th>
                        ...
                        @foreach($module as $item)
                            <tr>
                                ...
                                <td>@if($item->video){{asset($item->video)}} @endif</td>
                                ...
                                <td>
                                    ...
                                    <form class="form-horizontal deleteConfirm" method="POST"
                                          action="{{route('admin.video.destroy',$item->id)}}" role="form">

                                        <a href="{{route('admin.video.edit',$item->id)}}" class="">
