    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18">شرکای تجاری</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">داشبرد</a></li>
                        <li class="breadcrumb-item active">شرکای تجاری</li>
                    </ol>
                </div>
            ...
            <div class="col-lg-12">
                <div class="card" data-select2-id="10">
                    <div class="card-body" data-select2-id="9">
                        ...
                        <form method="post" action="{{route('admin.partner.update',$edit_item->id)}}" enctype='multipart/form-data' role="form">
                            {{csrf_field()}}
                            {{method_field('PUT')}}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form class="form-horizontal deleteConfirm" method="POST"
                                              action="{{route('admin.partner.destroy',$item->id)}}" role="form">

                                            <a href="{{route('admin.partner.edit',$item->id)}}" class="">
