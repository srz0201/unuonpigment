            ...
            <div class="page-title-box d-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">اسلایدر اصلی</li>
                    </ol>
                </div>
        ...
        <div class="col-lg-12">
            <div class="card" data-select2-id="10">
                <div class="card-body" data-select2-id="9">
                    ...
                    <form method="post" action="{{route('admin.home-slider.update',$edit_item->id)}}" enctype='multipart/form-data' role="form">
                        {{csrf_field()}}
                        {{method_field('PUT')}}
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form class="form-horizontal deleteConfirm" method="POST"
                                          action="{{route('admin.home-slider.destroy',$item->id)}}" role="form">

                                        <a href="{{route('admin.home-slider.edit',$item->id)}}" class="">
