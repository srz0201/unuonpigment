                        ...
                        @if(isset($feature))
                            <div class="portlet box blue ">
                                ...
                                <div class="portlet-body form">
                                    <form method="post" action="{{route('feature.update',$feature->id)}}" enctype='multipart/form-data' role="form">
                                        {{csrf_field()}}
                                        {{method_field('PUT')}}
                                        <div class="form-body">
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="lang" class="form-control">
                                                            @foreach($languages as $language)
                                                                <option @if(old('lang',$feature->language_id) == $language->id) selected @endif value="{{$language->id}}">{{$language->name}}</option>
                                                            @endforeach
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="order" type="number" min="1"
                                                               ...
                                                               @if($feature->order) value="{{$feature->order}}"
                                                               @else value="1" @endif
                                                               placeholder="1">
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <a href="{{route('feature.index')}}" class="btn btn-danger">انصراف</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
                        @else
                            <div class="portlet box blue ">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form method="post" action="{{route('feature.store')}}" enctype='multipart/form-data' role="form">
                                        {{csrf_field()}}
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-4">
                                ...
                                <table class="table table-striped table-bordered table-hover table-header-fixed"
                                    ...
                                    @foreach($module as $key=>$item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('feature.edit',$item->id)}}" class="btn btn-xs blue">
                                                    <i class="fa fa-edit"></i> ویرایش </a>
                                            </td>
                                            <td>

                                                <form class="form-horizontal deleteConfirm" method="POST"
                                                      action="{{route('feature.destroy',$item->id)}}" role="form">
                                                    {{method_field('DELETE')}}
                                                    {{csrf_field()}}
