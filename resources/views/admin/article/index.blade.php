    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18">مقالات</h4>
            ...
            <div class="col-lg-12">
                <div class="card" data-select2-id="10">
                    <div class="card-body" data-select2-id="9">
                        ...
                        <form method="post" action="{{route('admin.article.update',$edit_item->id)}}" enctype='multipart/form-data' role="form">
                            {{csrf_field()}}
                            {{method_field('PUT')}}
                            ...
                            <tr @if($item->status == 0) class="text-danger" @endif>
                                ...
                                <td >
                                    ...
                                    <form class="form-horizontal deleteConfirm" method="POST"
                                          action="{{route('admin.article.destroy',$item->id)}}" role="form">

                                        <a href="{{route('admin.article.show',$item->id)}}" class="">
                                            <i class="fa fa-eye font-size-16 align-middle mr-1"></i>  </a>
                                        <a href="{{route('admin.article.edit',$item->id)}}" class="">
