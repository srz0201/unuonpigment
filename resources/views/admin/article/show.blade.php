    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18">{{$article->title}}</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">داشبرد</a></li>
                        <li class="breadcrumb-item"><a href="{{route('admin.article.index')}}">مقالات</a></li>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div>
                        <form action="{{route('admin.article.gallery.store')}}" class="dropzone">
                            @csrf
                            <input name="model_id" type="hidden" value="{{$article->id}}">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <table id="b_datatable"
                        ...
                        <tbody>
                        @foreach($article->comments()->latest()->get() as $item)
                            <tr>
